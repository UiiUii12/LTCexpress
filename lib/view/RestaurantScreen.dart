...
class RestaurantScreen extends StatelessWidget {
  ...
  RxList<Food> List_of_food =CartController.commande.plats.obs;
                                        ...
                                        return Row(
                                          ...
                                          children: [
                                            CircleAvatar(
                                              ...
                                              child: Icon(
                                                EvaIcons.mapOutline,
                                                color: isOpened.value
                                                    ? Color(0xff669965)
                                                    : Colors.red,
                                                size: 26.sp,
                                              ),
                                              backgroundColor: isOpened.value
                                                  ? Color(0xffE8F7E5)
                                                  : Color(0xfff7e5ef),
                                            ),
                                            Spacer(
